    ...
    render={data => (
      <OuterContainer>
        <Container>
          ...
          <Description>
            Prem Patel is a core team member at blecan innovations Pvt ltd and a
            senior ReactJs frontend developer at{" "}
            <ImpSpan href="http://poispay.com/">poispay.com.</ImpSpan> And He
            lives in Ahmedabad, India.
          </Description>
          <Description>
            Prem has worked as a junior AngularJs developer at flikster.com.
            Prem has a bachelor degree in an Information Technology and has
            graduated from the codeastra coding Bootcamp. Prem also spoke on a
            several topics on Javascript and ReactJS. Prem also conducted
            workshop on ReactJS in several universities in Ahmedabad, India.
            Prem writes on Javascript, ReactJS and tools and technologies around
            it. Apart from writing and teaching code, Prem likes to strike
            conversation on science and philosophy. He also writes unique
            snippets of code which translate into poetry and he calls it code
            poetry.
          </Description>
          <Description>
